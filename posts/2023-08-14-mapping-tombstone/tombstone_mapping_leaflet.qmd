...
categories: [data visualization, R, R-code, leaflet, quarto, problem solving, mapping, code-along, spatial join, wordPress, leafpop, st_jitter] # self-defined categories
citation:
